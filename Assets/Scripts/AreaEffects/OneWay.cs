...
namespace CaptainHindsight
{
    public class OneWay : MonoBehaviour
    {
        ...
        [SerializeField] private bool movingLeftForbidden;
        [SerializeField] private bool movingRightForbidden;
        ...
        private void OnTriggerStay2D(Collider2D collision)
        {
            if (collision.CompareTag("Player") && PlayerManagement.Instance.PlayerIsDead == false)
            {
                // Stop player from moving the wrong way
                PlayerController.Instance.OneWayMovement(movingLeftForbidden, movingRightForbidden);
            }
        }

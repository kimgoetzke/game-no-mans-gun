...
{
    public class GlobalLeaderboardMenu : MonoBehaviour
    {
        [Header("Title")]
        ...
        private int leaderboardIDStaging = 3971;
        private int leaderboardIDLive = 3972;
        ...
        private void Start()
        {
            ...
            Helper.Log("GlobalLeaderboardMenu: Total score of " + score.ToString("N0") + " has been submitted.");

            // Submit score to global leaderboard
            LootLockerManager.Instance.SubmitScore(leaderboardID, score);
